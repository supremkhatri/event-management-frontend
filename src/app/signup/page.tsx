  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black p-6">
      <div className="bg-gray-800/30 backdrop-blur-md p-8 rounded-lg shadow-lg w-full max-w-md border border-gray-500/40 transition duration-300 hover:shadow-orange-400/40 hover:border-orange-400">
        <h1 className="text-3xl font-semibold text-center text-white mb-6">Signup</h1>
        <Formik
          initialValues={{
            name: "",
            email: "",
        ...
        >
          {() => (
            <Form className="space-y-5">
              ...
              {/* College Name field */}
              <div>
                <label htmlFor="collegeName" className="block text-sm font-medium text-gray-200 mb-1">College Name</label>
                <Field
                  type="text"
                  name="collegeName"
                  className="w-full px-4 py-2 border border-gray-500 rounded-md bg-transparent text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-400"
              ...
              <div>
                <label htmlFor="faculty" className="block text-sm font-medium text-gray-200 mb-1">Faculty</label>
                <Field
                  as="select"
                  name="faculty"
        ...
        <p className="text-gray-400 mt-4 text-center">
          ...
          <Link href="/login" className="text-orange-400 ml-3 hover:text-orange-300">Login</Link>
        </p>
      </div>
    </div>
  );
