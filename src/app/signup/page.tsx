...
const validationSchema = Yup.object({
  name: Yup.string().required("Name is required").matches(/^[a-zA-Z ]+$/,"Name must inlcude alphabet characters only").min(3,"Too short name"),
  email: Yup.string()
...
const Signup: React.FC = () => {
  ...
  return (
    <div className="min-h-screen mt-10 flex items-center justify-center bg-black p-6">
