export const EVENTS = [
  {
    ...
    status: "ongoing",
    registrationLink: "https://example.com/ai-registration",
    date: "2024-12-18",
    time: "10:00 AM",
    host: "AI Experts Group",
    location: "Tech Center, Silicon Valley",
    cost: "Free",
    image: "/images/sponsers/ecast-logo.png",
    tags: ["AI", "Machine Learning", "Workshop"],
    coordinates: { lat: 37.3877, lng: -122.0817 },
    description: "A hands-on workshop on AI and machine learning using Python.",
    ...
    Presenters: [
      {
        ...
        des: "Exploring the future of AI and its impact on society.",
        name: "David Miller",
      ...
      },
      {
        ...
        des: "Real-world applications of machine learning in business.",
        name: "Emily Clark",
    ...
    images: [
      "/images/sponsers/ecast-logo.png",
      "/images/sponsers/ecast-logo.png",
      "/images/sponsers/ecast-logo.png",
    ],
  },
  {
    ...
    description: "A seminar on the future of blockchain and cryptocurrency.",
    ...
    Presenters: [
      {
        ...
        des: "The evolution of blockchain technology and its impact.",
        name: "Samuel Green",
      ...
      },
      {
        ...
        des: "A deep dive into React and its ecosystem.",
        name: "Lucas Brown",
  ...
  },
  {
    ...
    status: "ongoing",
    registrationLink: "https://example.com/frontend-registration",
    date: "2024-12-20",
    time: "9:00 AM",
    host: "Frontend Dev Hub",
  ...
  },
  {
    ...
    date: "2025-01-10",
    time: "4:00 PM",
    host: "Cybersecurity Group",
    location: "Security Lab, London",
    cost: "Free",
    image: "/images/sponsers/ecast-logo.png",
    ...
    Presenters: [
      {
        ...
        des: "What’s next for the cybersecurity industry?",
        name: "James Black",
